...
export default function ChampionshipScenarioView({ driver, onBack }: ChampionshipScenarioViewProps) {
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1rem" }}>
        {[
          ...
          <div key={stat.label} className="panel" style={{ padding: "1.25rem" }}>
      ...
      {/* Two-Column Layout: Charts Left, Breakdowns Right */}
          ...
          <div className="panel" style={{ padding: "1.5rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              {data.scenarios.map((scenario) => (
                ...
                >
                  <div>
                    <div className="text-mono" style={{ fontSize: "0.55rem", color: "var(--text-muted)", marginBottom: "0.2rem", letterSpacing: "0.08em" }}>
                      SCENARIO
                    </div>
                    <div style={{ fontFamily: "var(--font-display)", fontSize: "0.8rem", fontWeight: 700, color: "var(--text-primary)" }}>
                      {scenario.outcome}
                    </div>
                  </div>
          ...
          <div className="panel" style={{ padding: "1.5rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "0.75rem" }}>
              {[
                ...
                <div key={item.race} style={{ padding: "0.75rem", background: "var(--bg-elevated)", borderRadius: "3px", border: "1px solid var(--border-subtle)" }}>
